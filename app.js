...
return {
    ...
    deleteItem: function(type, id){
      ...
      // looop over an array and get new array index
      // ids =[1 2 4 6 8 ]
      // get rid of 6, need index 3
...
var formatNumber = function(num, type){
  ...
  // +- befpre formatNumber//exactly 2 decimal points
  ...
  return {
    ...
    displayBudget: function(object){
      //budget , total income, expense, percentage
...
budgetCtrl.calculateBudget();
  ...
  var ctrlAddItem = function(){
    ...
    if (input.description !== "" && !isNaN(input.value) && input.value > 0){
      ...
      // calculate and update budget__title
...
//init function from Controller function.
controller.init();
